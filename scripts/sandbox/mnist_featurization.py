...
if __name__ == "__main__":
    ...
    random_patches = RandomPatches(mnist_train_dataset, threshold = threshold, K = num_patches, p = patch_size)
    ...
    with open("featurized_train_dataset.pkl", "wb") as f:
        pickle.dump(featurized_train_dataset, f)

    with open("featurized_val_dataset.pkl", "wb") as f:
